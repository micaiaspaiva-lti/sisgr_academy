...
export default function AlunoLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4 antialiased font-sans">
      ...
      {/* Login Card */}
      <div className="w-full max-w-md bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 md:p-10 shadow-2xl flex flex-col gap-6 relative z-10">
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1">
            <label className="text-3xs font-extrabold text-slate-400 uppercase tracking-wider pl-1">E-mail</label>
        ...
        <div className="relative flex py-2 items-center">
          ...
          <span className="flex-shrink mx-4 text-slate-600 text-3xs font-black uppercase tracking-wider">Ou Sandbox</span>
          <div className="flex-grow border-t border-slate-800"></div>
        </div>
